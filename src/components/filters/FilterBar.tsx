...
export default function FilterBar() {
  ...
  return (
    <div className="flex items-center gap-2 sm:gap-3 flex-wrap px-3 sm:px-5 py-2 sm:py-3 bg-bg-2 border-b border-border-1 min-h-[48px]">
      {/* Search */}
      <div className="relative flex items-center w-full sm:w-auto">
        ...
        <input
          ...
          className="bg-bg-3 border border-border-1 rounded-md text-slate-300 text-xs pl-8 pr-3 py-1.5 focus:outline-none focus:border-accent transition-colors w-full sm:w-48 placeholder-slate-500"
        />
      </div>
